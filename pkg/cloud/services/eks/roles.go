...
func (s *Service) getIAMRole(name string) (*iam.Role, error) {
	...
	out, err := s.scope.IAM.GetRole(input)
	if err != nil {
		return nil, err
	}
...
func (s *Service) getIAMPolicy(policyArn string) (*iam.Policy, error) {
	...
	out, err := s.scope.IAM.GetPolicy(input)
	if err != nil {
		return nil, err
	}
...
func (s *Service) getIAMRolePolicies(roleName string) ([]*string, error) {
	...
	out, err := s.scope.IAM.ListAttachedRolePolicies(input)
	if err != nil {
...
func (s *Service) detatchIAMRolePolicy(roleName string, policyARN string) error {
	...
	_, err := s.scope.IAM.DetachRolePolicy(input)
	if err != nil {
...
func (s *Service) attachIAMRolePolicy(roleName string, policyARN string) error {
	...
	_, err := s.scope.IAM.AttachRolePolicy(input)
	if err != nil {
...
func (s *Service) createRole(name string) (*iam.Role, error) {
	...
	out, err := s.scope.IAM.CreateRole(input)
	if err != nil {
		return nil, err
	}
...
func (s *Service) deleteRole(name string) error {
	...
	_, err := s.scope.IAM.DeleteRole(input)
	if err != nil {
